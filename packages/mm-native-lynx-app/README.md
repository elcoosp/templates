...
<div align="center">
  ...
  <h4 align="center">@elcoosp-templates/mm-native-lynx-app</h4>
  <p align="center">
...
> [!NOTE]
> You are inside the **@elcoosp-templates/mm-native-lynx-app** workspace member package, not the repository entry point
...
```sh
npm add @elcoosp-templates/mm-native-lynx-app
```
```sh
pnpm add @elcoosp-templates/mm-native-lynx-app
```
```sh
yarn add @elcoosp-templates/mm-native-lynx-app
```
```sh
deno add npm:@elcoosp-templates/mm-native-lynx-app
```
...
[npm-version-shield]: https://img.shields.io/npm/v/@elcoosp-templates/mm-native-lynx-app.svg?style=for-the-badge
[npm-version-url]: https://www.npmjs.com/package/@elcoosp-templates/mm-native-lynx-app
[codecov-shield]: https://img.shields.io/codecov/c/github/elcoosp/templates/main.svg?style=for-the-badge
[codecov-url]: https://codecov.io/github/elcoosp/templates/tree/main/packages/mm-native-lynx-app
